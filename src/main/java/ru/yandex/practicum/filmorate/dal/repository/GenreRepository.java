...
public class GenreRepository extends BaseRepository<Genre> {
    ...
    private static final String INSERT_GENRES_TO_FILM_QUERY = "INSERT INTO film_genres (film_id, genre_id) VALUES (?, ?)";
    ...
    public List<Genre> findGenresFilmById(Long filmId) {
        return findMany(FIND_GENRES_BY_FILM_QUERY, filmId);
    }

    public void insertGenresToFilm(Long filmId, Set<Genre> genres) {
